        ...
        <>
            <div className='flex flex-col mx-auto h-screen  '> 
                <div className='mx-auto m-10 my-auto '>
                    ...
                    <p className='text-neutral-800 font-bold  sm:text-3xl md:text-xl lg:text-3xl'>
                        {aboutMe.fullName} <span className='text-red-500 sm:text-xs md:text-xs lg:text-sm'>{aboutMe.aka}</span>
                    </p>
